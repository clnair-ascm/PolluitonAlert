...
aqlist <- readRDS("/Users/yqdai/Downloads/RedAlert/data/chap_era5_daily/aqmet_incalert_predv3.rds")
meta <- read_xlsx("/Users/yqdai/Downloads/RedAlert/data/meta.xlsx")
